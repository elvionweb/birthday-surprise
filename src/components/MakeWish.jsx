...
export default function MakeWish({ onFocus }) {
  ...
  return (
    <section className="relative overflow-hidden h-screen flex items-center justify-center bg-black text-white px-4">
      ...
      {!clicked ? (
        ...
        >
          ...
          <p className="text-xl sm:text-2xl text-center leading-relaxed">
            Today we celebrate everything about you, your strength, and the
            story God is writing in your life. Every step, every challenge,
            every quiet moment you never told anyone but God. You are not just
            living you are growing, shining, and leaving a mark only you can
            leave. May all your dreams come true and your day be magical!
          </p>
        </motion.div>
      )}
    </section>
